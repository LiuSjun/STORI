...
class Model(nn.Module):
    ...
    def build(self):
        ...
        self.rits_f = rits.Model(self.rnn_hid_size, self.INPUT_SIZE, self.SEQ_LEN, self.SELECT_SIZE)
        self.rits_b = rits.Model(self.rnn_hid_size, self.INPUT_SIZE, self.SEQ_LEN, self.SELECT_SIZE)
    ...
    def get_consistency_loss(self, pred_f, pred_b):
        loss = torch.abs(pred_f - pred_b).mean() * 1e-1    #fixed 可能的修改地方
        return loss
